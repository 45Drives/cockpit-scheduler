<template>
    <Modal @close="closeModal" :isOpen="showEditTaskWizard" :margin-top="'mt-12'" :width="'w-3/5'" :min-width="'min-w-3/5'">
        ...
        <template v-slot:footer>
            <div class="w-full">
				<div class="button-group-row w-full justify-between">
					...
					<div class="button-group-row">
                        <button v-if="!saving" id="add-task-btn" class="btn btn-primary object-right justify-end h-fit w-full" @click="saveChangesBtn">Save Task</button>
