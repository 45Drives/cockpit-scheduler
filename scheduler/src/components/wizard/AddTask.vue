        ...
        <template v-slot:footer>
            <div class="w-full">
				<div class="button-group-row w-full justify-between">
                    ...
                    <div class="button-group-row">
                        <button disabled v-if="!adding && !selectedTemplate" id="add-task-btn-error" class="btn btn-primary h-fit w-full" @click="addTaskBtn">Add Task</button>
                        <button v-if="!adding && selectedTemplate" id="add-task-btn" class="btn btn-primary h-fit w-full" @click="addTaskBtn">Add Task</button>
