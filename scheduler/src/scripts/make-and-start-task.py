...
def main():
    ...
    timer_template_content = timer_template_content.replace("{description}", "Timer for " + task_template_name + "_" + task_instance_name).replace("{on_calendar_lines}", on_calendar_lines_str)
