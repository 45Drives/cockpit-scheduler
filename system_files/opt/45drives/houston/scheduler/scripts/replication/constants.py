...
PIPELINE_FINALIZE_TIMEOUT = int(os.environ.get("ZFS_REP_FINALIZE_TIMEOUT", "14400"))
...
# `zfs send -nP -t <token>` prints a negative remaining size as an unsigned 64-bit
# value when the resumed stream is already complete. Treat that magnitude as bogus.
MAX_PLAUSIBLE_SEND_SIZE = 1 << 62
