...
# An empty RSYNC_DEBUG_LOG in the unit's env file would otherwise win over the default.
DEBUG_LOG = os.environ.get("RSYNC_DEBUG_LOG", "").strip() or (
    f"/tmp/rsync_task_debug_{_DEBUG_TASK_NAME}.log" if _DEBUG_TASK_NAME else "/tmp/rsync_task_debug.log"
)
...
if __name__ == '__main__':
    ...
    run_with_retry_policy(main, permanent_exit_codes=(2,), unit_prefix="houston_scheduler_RsyncTask_")
