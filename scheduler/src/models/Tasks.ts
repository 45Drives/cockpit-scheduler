    ...
    constructor() {
        ...
        const parameterSchema = new ParameterNode("ZFS Replication Task Config", "zfsRepConfig")
            ...
            .addChild(new ParameterNode('Send Options', 'sendOptions')
                ...
                .addChild(new BoolParameter('Include Intermediate Snapshots', 'includeIntermediateSnapshots', false))
                .addChild(new IntParameter('MBuffer Size', 'mbufferSize', 1))
                .addChild(new StringParameter('MBuffer Unit', 'mbufferUnit', 'G'))
                .addChild(new IntParameter('MBuffer Block Size', 'mbufferBlockSize', 256))
                .addChild(new StringParameter('MBuffer Block Unit', 'mbufferBlockUnit', 'k'))
                .addChild(new StringParameter('MBuffer Callback Host', 'mbufferCallbackHost', ''))
                ...
                .addChild(new BoolParameter('Auto Recover', 'autoRecover', true))
